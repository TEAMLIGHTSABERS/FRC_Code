...
The resulting "Overview" page will then show that there is an Active branch called "jsmithDev".  You can click on the "jdoeDev" branch and you will see that it has the same files as were in the "main" branch.
